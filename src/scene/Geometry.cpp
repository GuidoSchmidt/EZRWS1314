...
namespace tone {
	namespace scene {
		...
		//! \brief Creates a simple triangle
		...
		//! \brief Creates the normals for rendering
		...
		//! \brief Creates the bounding box geometry
		...
		//! \brief Creates OpenGL buffers for rendering
		...
		//! \brief Creates OpenGL buffers for rendering normals
		...
		//! \brief renders the normals of the geometry
		...
		//! \brief Renders the geometry as triangles
		...
		//! \brief Renders the geometry as points
